    ...
    <article className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <dl className="mt-4 grid gap-3 text-sm sm:grid-cols-2">
        ...
        <div className="rounded-2xl bg-emerald-50 p-3">
          <dt className="text-emerald-700">قیمت نهایی</dt>
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        <button
          ...
          className="min-h-12 rounded-xl border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-800 transition hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-200"
